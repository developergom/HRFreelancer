...
INSERT INTO `announcements` VALUES (1,'Development','This application is under maintenance','2016-11-23','2016-12-12','1',1,16,'2016-10-05 22:27:02','2016-11-23 01:56:30'),(2,'Pengumuman 2','Pengumuman 2 YA','2016-10-06','2016-10-06','1',1,0,'2016-10-05 22:33:08','2016-10-05 22:33:08'),(3,'Pengumuman 3','Pengumuman3','2016-10-06','2016-10-07','1',1,0,'2016-10-05 22:33:35','2016-10-05 22:33:35'),(4,'Pengumuman 4','Kemarin','2016-10-01','2016-10-06','1',1,0,'2016-10-05 22:38:42','2016-10-05 22:38:42'),(5,'Pengumuman 5','Pengumuman 5','2016-10-05','2016-10-08','1',1,0,'2016-10-05 22:39:16','2016-10-05 22:39:16');
...
CREATE TABLE `departments` (
  ...
  `department_desc` text CHARACTER SET utf8 NOT NULL,
  `active` enum('0','1') COLLATE utf8_unicode_ci NOT NULL DEFAULT '1',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `departments` VALUES (1,2,'HR Department','HR Department','1',1,1,'2016-11-23 01:47:22','2016-11-23 01:48:07'),(2,1,'GMC','Gramedia Majalah Community','1',1,NULL,'2016-11-28 00:26:22','2016-11-28 00:26:22'),(3,3,'ACT','ACT','1',1,NULL,'2016-11-28 00:27:05','2016-11-28 00:27:05'),(4,6,'Nova','Nova','1',1,NULL,'2016-11-28 00:27:36','2016-11-28 00:27:36');
...
CREATE TABLE `divisions` (
  ...
  `division_desc` text COLLATE utf8_unicode_ci NOT NULL,
  `active` enum('0','1') COLLATE utf8_unicode_ci NOT NULL DEFAULT '1',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `divisions` VALUES (1,'Business Division','','1',1,1,'2016-11-23 00:42:46','2016-11-23 00:42:46'),(2,'HR & GA Division','','1',1,1,'2016-11-23 00:42:46','2016-11-23 00:42:46'),(3,'Media Services Devision','','1',1,1,'2016-11-23 00:42:46','2016-11-23 00:42:46'),(4,'Publishing General Interest Media Division','','1',1,1,'2016-11-23 00:42:46','2016-11-23 00:42:46'),(5,'Publishing Special Interest Media Division','','1',1,1,'2016-11-23 00:42:46','2016-11-23 00:42:46'),(6,'Publishing Women & Children Media Division 	','','1',1,1,'2016-11-23 00:42:46','2016-11-23 00:42:46'),(7,'Strategic Management Office Division','','1',1,1,'2016-11-23 00:42:46','2016-11-23 00:42:46');
...
CREATE TABLE `freelancers` (
  `freelancer_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `last_education` enum('SMA/SMK','D1','D2','D3','D4','S1','S2','S3') COLLATE utf8_unicode_ci NOT NULL,
  ...
  `ktp_village_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `ktp_address` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `home_city` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `home_village_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `history_freelancers`
--

DROP TABLE IF EXISTS `history_freelancers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `history_freelancers` (
  `history_freelancer_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `history_freelancers`
--

LOCK TABLES `history_freelancers` WRITE;
/*!40000 ALTER TABLE `history_freelancers` DISABLE KEYS */;
INSERT INTO `history_freelancers` VALUES (2,2,1,1,5000000,'by project','2016-11-01','2016-11-30','1',17,NULL,'2016-11-24 01:45:05','2016-11-24 01:45:05'),(3,3,1,1,5000000,'monthly','2016-01-01','2016-12-31','1',18,NULL,'2016-11-24 01:54:20','2016-11-24 01:54:20'),(4,4,1,1,600000,'by project','2016-10-01','2016-10-31','1',18,NULL,'2016-11-24 20:52:44','2016-11-24 20:52:44'),(14,5,1,1,20000,'daily','2015-12-13','2016-12-13','1',16,NULL,'2016-11-25 01:56:16','2016-11-25 01:56:16'),(15,1,1,1,3600000,'monthly','2015-01-01','2016-01-01','1',16,NULL,'2016-11-25 01:57:48','2016-11-25 01:57:48'),(16,6,1,1,2000000,'monthly','2016-10-01','2016-11-30','1',16,NULL,'2016-11-25 02:17:22','2016-11-25 02:17:22'),(17,7,4,1,3200000,'monthly','2016-06-01','2016-12-31','1',16,NULL,'2016-11-28 00:31:15','2016-11-28 00:31:15'),(18,8,3,2,5000000,'monthly','2016-01-01','2016-12-31','1',16,NULL,'2016-11-28 00:39:27','2016-11-28 00:39:27'),(19,9,3,1,15000000,'by project','2016-10-01','2017-01-31','1',17,NULL,'2016-11-28 00:44:19','2016-11-28 00:44:19'),(21,10,2,2,10000000,'by project','2016-07-06','2016-10-08','1',17,NULL,'2016-11-28 23:00:36','2016-11-28 23:00:36'),(22,10,2,3,12500000,'by project','2016-11-01','2017-02-28','1',17,NULL,'2016-11-28 23:00:36','2016-11-28 23:00:36');
...
INSERT INTO `modules` VALUES (1,'/home','','Home for dashboard','1',1,NULL,'2016-07-13 20:37:38','2016-07-13 20:37:38'),(2,'/user','','Module for user management','1',1,NULL,'2016-07-13 20:38:20','2016-07-13 20:38:20'),(3,'/master/#','','Module for master data parent','1',1,NULL,'2016-07-13 20:39:14','2016-07-13 20:39:14'),(4,'/master/action','','Module for Action Control Management','1',1,1,'2016-07-13 20:40:30','2016-10-11 19:23:20'),(12,'/master/group','','Module for Group Management','1',1,NULL,'2016-07-13 20:49:51','2016-07-13 20:49:51'),(13,'/master/holiday','','Module for Holiday Management','1',1,NULL,'2016-07-13 20:50:21','2016-07-13 20:50:21'),(19,'/master/menu','','Module for Menu Management','1',1,NULL,'2016-07-13 20:57:30','2016-07-13 20:57:30'),(20,'/master/module','','Module for Module Management','1',1,NULL,'2016-07-13 20:58:39','2016-07-13 20:58:39'),(23,'/master/religion','','Module for Religion Management','1',1,NULL,'2016-07-13 21:00:40','2016-07-13 21:00:40'),(24,'/master/role','','Module for Role Management','1',1,NULL,'2016-07-13 21:01:10','2016-07-13 21:01:10'),(27,'/master/flowgroup','','Module for Flow Group Management','1',1,NULL,'2016-07-20 21:38:03','2016-07-20 21:38:03'),(30,'/master/flow','','Flow Management','1',1,NULL,'2016-08-22 01:16:35','2016-08-22 01:16:35'),(31,'/master/notificationtype','','Module for Master Notification Type','1',1,NULL,'2016-08-31 20:40:21','2016-08-31 20:40:21'),(35,'/config/#','','Module for configuration','1',1,1,'2016-10-04 21:46:46','2016-10-04 21:48:07'),(36,'/config/setting','','Module for application settings','1',1,NULL,'2016-10-04 21:49:26','2016-10-04 21:49:26'),(37,'/config/announcement','','Module for Announcement Management','1',1,NULL,'2016-10-05 22:05:23','2016-10-05 22:05:23'),(38,'/master/division','','Module for Division Management','1',1,NULL,'2016-11-23 01:01:22','2016-11-23 01:01:22'),(39,'/master/position','','Module for Position Management','1',1,NULL,'2016-11-23 01:16:10','2016-11-23 01:16:10'),(40,'/master/department','','Module for Departments Management','1',1,NULL,'2016-11-23 01:40:30','2016-11-23 01:40:30'),(41,'/freelancer','','Module for freelancer','1',1,NULL,'2016-11-23 02:34:49','2016-11-23 02:34:49'),(42,'/report','','Module for reporting','1',1,NULL,'2016-11-29 01:33:19','2016-11-29 01:33:19');
...
CREATE TABLE `positions` (
  ...
  `position_desc` text COLLATE utf8_unicode_ci NOT NULL,
  `active` enum('0','1') COLLATE utf8_unicode_ci NOT NULL DEFAULT
,2,1),(2,4,3,1),(2,12,1,1),(2,12,2,1),(2,12,3,1),(2,12,4,1),(2,13,1,1),(2,13,2,1),(2,13,3,1),(2,13,4,1),(2,19,1,1),(2,19,2,1),(2,19,3,1),(2,20,1,1),(2,20,2,1),(2,20,3,1),(2,31,1,1),(2,31,2,1),(2,31,3,1),(2,31,4,1),(2,23,1,1),(2,23,2,1),(2,23,3,1),(2,23,4,1),(2,24,1,1),(2,24,2,1),(2,24,3,1),(2,42,2,1),(2,42,5,1),(2,42,9,1),(2,35,2,1),(2,37,1,1),(2,37,2,1),(2,37,3,1),(2,37,4,1),(2,36,2,1),(2,36,3,1);
...
INSERT INTO `settings` VALUES (1,'app_name','Application Name','Application\'s Name','<b>GOM</b>Freelancer','1',1,1,'2016-10-04 22:19:22','2016-11-22 23:30:45');
...
INSERT INTO `users` VALUES (1,'025407','soni@gramedia-majalah.com','$2y$10$1LdG9jpzi6kJJZFcUblN8umDjFQZfsDSC.vycnwh6bbta/hTnj0VS','Soni','Rahayu','081220493870','1',1,'1990-09-06',NULL,NULL,'201610190935312016-W-Motors-Fenyr-SuperSport-Concept.jpg','ACTIVE','1',1,1,'bfnWzCoD4fa60FvGFdxTc5HfaZq4suCbNVbZRBZbveyYWt3F1MQLO99kJ3sb','2016-05-19 02:00:10','2016-11-28 00:32:47'),(15,'000000','admin@admin.com','$2y$10$bDcWDAcug4u0OGrenwehCuqdDZBkCvZ63dmSgpun552lhTVfp6liS','Operator','Application','085522002200','2',1,'2000-01-01',NULL,NULL,'avatar-female.jpg','ACTIVE','1',1,NULL,'v22P10fFmBOB3QHf0eoOziOzlMwNwwx3gewNYQ4ZzcDUpYf5CPDYRdvnxmEg','2016-10-11 20:18:59','2016-10-11 20:21:31'),(16,'hrofficer','hr.officer@gramedia-majalah.com','$2y$10$.X7yxVKb0aAzTFnjApujw.eSRGkdigRhdowG4NT/zQYU6oCuFTwWe','HR','Officer','081122154451','1',7,'1990-01-01',NULL,NULL,'avatar.jpg','ACTIVE','1',1,1,'2wy5gk6lGCEdzNM8xNBswfPOE6kh7bhal9ozeQdoVjvlnpeCpL3Q8DQ8nl06','2016-11-23 01:54:40','2016-11-29 01:32:25'),(17,'secretary1','secretary1@gmail.com','$2y$10$jMboSjL27FCTFGZzP/2F/.i4j6A73EFQ1JBUYG0llkBQZwA06W4Gy','Secretary','1','','2',7,'1990-12-12',NULL,NULL,'avatar-female.jpg','ACTIVE','1',1,NULL,'KiEhlGMXf3KtpOLmGEGgDelIJP71iogWTnnkj9iFUglnYl6vqFh7lM6Ofq88','2016-11-24 01:41:54','2016-11-29 01:16:40'),(18,'secretary2','secretary2@gmail.com','$2y$10$aW7Fx8o3pAjRAxzoGI7aWujRF0dhIVro2FISUMp1n3rU7WMJPbcoy','Secretary','2','','2',7,'1990-12-12',NULL,NULL,'avatar-female.jpg','ACTIVE','1',1,NULL,'hIS89liRVHvwaMRCRYg8nZmNaifRwq01hfq5rtEQCxcNFXUAXWpMufEnbj7c','2016-11-24 01:42:30','2016-11-25 01:12:45');
...
--
-- Dumping events for database 'hrfreelancer'
--

--
-- Dumping routines for database 'hrfreelancer'
--
...
-- Dump completed on 2016-11-30 14:43:55
